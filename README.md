...
- `ML_FETCH_HUMAN_REVERTS` (`1/0`, collecte dédiée de reverts humains)
- `ML_FETCH_HUMAN_REVERTS_FR` et `ML_FETCH_HUMAN_REVERTS_EN` (activer par langue)
- `ML_HUMAN_REVERT_DAYS`, `ML_HUMAN_REVERT_MAX_RC`, `ML_HUMAN_REVERT_MAX_DIFFS` (profondeur collecte reverts humains)
